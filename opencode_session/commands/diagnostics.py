...
from opencode_session.diagnostics import ApiDiagnosticsError, ApiDiagnosticsService, format_routes_compact
    ...
    *,
    ...
    try:
        ...
        if args.diagnostics_command == "get":
            ...
            return render_command_result(args, response.data, raw_body=response.body)
