...
class OcsUxContractTest(unittest.TestCase):
    ...
    def test_readme_examples_use_finalized_ocs_vocabulary(self):
        ...
        self.assertIn("E2E runs every E2E test", readme)
        self.assertNotIn("OCS_E2E" + "_LIVE", readme)
        self.assertIn("OCS_E2E_AGENT", readme)
        self.assertIn("OCS_E2E_MODEL", readme)
        self.assertIn("spend provider tokens", readme)
